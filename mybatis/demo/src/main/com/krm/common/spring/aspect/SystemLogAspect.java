package com.krm.common.spring.aspect;
...
import com.krm.common.spring.annotation.Log;
...
public class SystemLogAspect {
	...
	@Pointcut("@annotation(com.krm.common.spring.annotation.Log)")
	public void accessAspect() {
	}
	
	@Pointcut("execution(* com.krm.web..*Service.*(..))")
