...
import com.krm.common.excel.template.PoiTemplate;
import com.krm.common.excel.template.utils.PoiUtil;
...
public class ExcelUtils {
	...
	public static void exportExcel(HttpServletResponse response,
		...
		PoiUtil.writeExcel2007(data, os, titleMap);
		os.flush();
	 ...
	 */
	public static void exportExcel(HttpServletResponse response,
			String fileName, Map titleMap) throws Exception {
		ByteArrayOutputStream os = new ByteArrayOutputStream();
		//PoiUtil.writeExcel(data, os, titleMap);
		PoiUtil.writeExcelTmpl2007(os, titleMap);
		os.flush();
		byte[] buf = os.toByteArray();
		InputStream is = new ByteArrayInputStream(buf, 0, buf.length);
		FileUtils.downloadFile(response, is, fileName);
