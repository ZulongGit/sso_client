 ...
 * 2018-08-22
 */
public interface DemoDataImpLogMapper extends Mapper<DemoDataImpLog>{
	 ...
	 * 列表查询,返回的是实体
	 */
	List<DemoDataImpLog> entityList(Map<String, Object> params);
	/**
	 * 查询单条数据,返回的是实体
	 */
	DemoDataImpLog queryOne(Map<String, Object> params);
	/**
	 ...
	 * 批量插入数据
	 */
	int insertBatch(List<DemoDataImpLog> list);
	/**
	 * 根据不同条件删除数据，条件可组合
	 */
