...
import com.krm.common.excel.ExcelUtils;
...
public class AreaController extends BaseController{
	...
	public static final String BASE_URL = "area";
	private static final String BASE_PATH = "sys/area/";
	...
	public @ResponseBody void importFile(HttpServletRequest request,
		...
		ExcelConfig config = new ExcelConfig.Builder(Map.class)
				...
				.addColumn("name", "code,java.lang.String", "pname",
						"parentId,java.lang.String", "parentIds", "type", "icon",
