...
([function (e, t, s) {
			...
			function a(e, t) {
				...
				if (t.singleton) {
					...
					e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (s = n(), r = u.bind(null, s), i = function () {
			...
			if (!localStorage.getItem(n)) {
				...
				l = {
					user: {
						id: 1,
						name: "Coffce111",
						img: "${ctxPath!}/static/chat/images/1.jpg"
					},
					userList: [{
							id: 2,
							name: "示例介绍",
							img: "${ctxPath!}/static/chat/images/2.png"
						}, {
							id: 3,
							name: "webpack",
							img: "${ctxPath!}/static/chat/images/3.jpg"
						}
					],
					sessionList: [{
							userId: 2,
