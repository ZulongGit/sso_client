...
<div class="clearfix">
	...
	<div>
		...
		@		if(currentPage == 1){
						<li class="prev disabled"><a href="javascript:void(0);" onclick="return false;"></a></li>
		@			}else{
						<li><a href="javascript:void(0);" onclick="paging('${formId}',${currentPage - 1});return false;"></a></li>
		@			}
		@	      if(totalPage <= 8){
		@	       var i = 1;
		@	       while(i <= totalPage){
		...
		@		    if(currentPage == totalPage){
						<li class="next disabled"><a href="javascript:void(0);" onclick="return false;"></a></li>
		@			}else{
						<li><a href="javascript:void(0);" onclick="paging('${formId}',${currentPage + 1});return false;"></a></li>
		@			}
			</div>
